...
from dispositivos.models import Nutricional, Categoria, Producto, ReglaAlertaVencimiento, ProductoReglaAlerta
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Ruta corregida: sube dos directorios (de 'commands' a 'dispositivos')
        fixtures_dir = os.path.join(base_dir, '..', '..', 'fixtures')
        
        # El orden es crucial para las llaves foráneas
        files = [
            '00_nutricional.json',
        ...
        with transaction.atomic():
            for filename in files:
                ...
                try:
                    ...
                    self.stdout.write(self.style.ERROR(f"✖ Archivo {filename} no encontrado."))
    ...
    def process_fixture_data(self, data):
        for item in data:
            ...
            elif model_name == 'productoreglalerta':
